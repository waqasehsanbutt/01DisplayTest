...
#include "FontChip_PinAssignments.h"
#include "FontChip.h"
#include "SPI_HLD.h"
#include "Images.h"
#include "Delays.h"
...
/********************* Variables **********************/
// Initialize SPI IOs
static inline void FontChip_InitSPIIOs(void)
{
	FONT_PCS_PORT->PCR[FONT_PCS_PIN] = PORT_PCR_MUX(FONT_PCS_MUX) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
}

// Initialize Control IOs
static inline void FontChip_InitControlIOs(void)
{
	
}

// Initialize Peripherals
static inline void FontChip_InitPeripherals(void)
{
	FontChip_InitControlIOs();
	FontChip_InitSPIIOs();
}
...
{
	ENBL_CLKS;
	FontChip_InitPeripherals();
//	FontChip_SendInitSequence();
}
