...
#include "SDCard_PinAssignments.h"
#include "SDCard.h"
#include "SPI_HLD.h"
#include "Images.h"
#include "Delays.h"
...
/********************* Variables **********************/
// Initialize SPI IOs
static inline void SDCard_InitSPIIOs(void)
{
	SD_PCS_PORT->PCR[SD_PCS_PIN] = PORT_PCR_MUX(SD_PCS_MUX) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK;
}

// Initialize Control IOs
static inline void SDCard_InitControlIOs(void)
{

}

// Initialize Peripherals
static inline void SDCard_InitPeripherals(void)
{
	SDCard_InitControlIOs();
	SDCard_InitSPIIOs();
}
